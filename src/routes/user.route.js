...
router.post('/create', createUserSchema, awaitHandlerFactory(userController.createUser)); // localhost:3000/api/v1/users
router.patch('/id/:id', awaitHandlerFactory(userController.updateUser)); // localhost:3000/api/v1/users/id/1 , using patch for partial update
router.delete('/id/:id', awaitHandlerFactory(userController.deleteUser)); // localhost:3000/api/v1/users/id/1
